...
<div class="max-w-7xl mx-auto px-4 py-8">
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-2xl font-bold text-[#0B2E4F]">Buat Template Baru</h1>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="bg-white p-6 rounded-xl shadow">
                    ...
                    <input type="text" name="judul" required class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500" placeholder="Contoh: Surat Keterangan Tidak Mampu" value="{{ old('judul') }}">
                </div>
                ...
                <div class="bg-white p-6 rounded-xl shadow">
                    ...
                    <textarea name="body" id="body-content" class="hidden">{{ old('body') }}</textarea>
                </div>
            </div>
            ...
            <div class="space-y-6">
                <div class="bg-white p-6 rounded-xl shadow sticky top-6">
                    ...
                    <button type="submit" class="w-full bg-[#1E8449] text-white px-4 py-3 rounded-lg hover:bg-green-700 font-bold">
                        Simpan Template
                    </button>
                </div>
            </div>
