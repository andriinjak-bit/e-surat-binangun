            ...
            <main className="max-w-7xl mx-auto px-4 md:px-8 py-10 mt-8 md:mt-0">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 mb-10">
                    ...
                    <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-200 relative">
                        ...
                        <div className="text-4xl font-bold text-[#b4802c]">24</div>
                ...
                <div className="bg-white rounded-xl shadow-sm overflow-hidden">
                    ...
                    <div className="overflow-x-auto">
                        <table className="w-full text-left text-sm whitespace-nowrap">
                            <thead className="bg-[#f8f9f2] text-gray-500 text-xs font-semibold tracking-wider">
                                <tr>
                            ...
                            <tbody className="divide-y divide-gray-100">
                                {[
                                    { name: 'Ahmad Bakri', nik: '3301021405920001', type: 'Surat Keterangan Domisili', date: '24 Okt 2023', status: 'AKTIF', statusColor: 'bg-[#2b3a20] text-white' },
                                    { name: 'Siti Rahayu', nik: '3301024810880004', type: 'Pindah Datang', date: '22 Okt 2023', status: 'PINDAHAN', statusColor: 'bg-yellow-500 text-white' },
                                    { name: 'Bambang Pamungkas', nik: '3301020202950009', type: 'Surat Keterangan Usaha', date: '21 Okt 2023', status: 'AKTIF', statusColor: 'bg-[#2b3a20] text-white' },
                                    { name: 'Dewi Lestari', nik: '3301025506990002', type: 'Surat Tidak Mampu', date: '20 Okt 2023', status: 'AKTIF', statusColor: 'bg-[#2b3a20] text-white' },
                                ].map((row, idx) => (
                                    <tr key={idx} className="hover:bg-gray-50 transition">
                                        <td className="px-6 py-4 font-medium text-gray-800">{row.name}</td>
                                        <td className="px-6 py-4 text-gray-500">{row.nik}</td>
                                        ...
                                        <td className="px-6 py-4">
                                            <div className="flex items-center gap-3 text-gray-400">
                                                ...
                                                <button className="hover:text-gray-700 transition"><Edit2 size={18} /></button>
                                            </div>
                                        </td>
                                    </tr>
                                ))}
