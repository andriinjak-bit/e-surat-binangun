...
<div class="max-w-7xl mx-auto px-4 py-8">
    <div class="flex justify-between items-center mb-6">
        ...
        <div class="flex gap-2">
            ...
            <a href="{{ route('admin.surat.index') }}" class="bg-[#0B2E4F] text-white px-4 py-2 rounded-lg hover:bg-[#1B4A7A] font-bold text-sm">Manage Surat</a>
        </div>
    </div>
                ...
                <table class="w-full text-sm">
                    ...
                    <tbody>
                        ...
                        <tr class="border-b">
                            ...
                            <td class="px-4 py-2">
                                <a href="{{ route('surat.show', $surat) }}" class="text-blue-600 hover:underline text-xs">Detail</a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
